...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
  ...
  .state('app.report', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/report/lapor.html",
  ...
  .state('app.done', {
      ...
      views: {
          'menuContent': {
              templateUrl: 'views/app/report/done.html',
              controller: 'IlegalCtrl'
          }
      }
  })
  ...
  .state('app.ilegal', {
      ...
      views: {
          'menuContent': {
              templateUrl: 'views/app/report/ilegal.html',
              controller: 'IlegalCtrl'
          }
      }
  })
  ...
  .state('app.legal', {
      ...
      views: {
          'menuContent': {
              templateUrl: 'views/app/report/legal.html',
              controller: 'IlegalCtrl'
          }
      }
  })
  ...
  .state('app.profile2', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/profile2.html"
      }
    }
  })

  .state('profile.ilegal', {
      url: "/ilegal",
      views: {
  ...
  // create tabs position on top of page.
